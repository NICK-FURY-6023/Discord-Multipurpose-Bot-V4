...
class give(commands.Cog):
    ...
    async def gstart(self, ctx):
        ...
        init = await ctx.send(embed=discord.Embed(
            title=f"<a:anxTada:1113899306148184144> Giveaway <a:anxTada:1113899306148184144>",
            description=f"<a:anxTada:1113899306148184144> **Answer the questions for the giveaway.**",
            color=self.color)
        ...
        giveaway_embed = discord.Embed(
            title="<a:anxTada:1113899306148184144> {} ".format(prize),
            color=self.color,
        ...
        giveaway_message = await channel.send(content="<a:anxTada:1113899306148184144> **GIVEAWAY STARTED** <a:anxTada:1113899306148184144>", embed=giveaway_embed, view=action_row)
